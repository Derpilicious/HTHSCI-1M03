...
str(outlier_example)
```
Uses the **str()** function to display the **outlier_example** object to see there is 500 entries.

```{r}
length(outlier_example)
```
Alternatively, the **length()** function also demonstrates that there are 500 entries in **outlier_example**.
